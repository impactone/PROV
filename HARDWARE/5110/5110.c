...
0x00,0x7F,0x49,0x49,0x49,0xFF,0x49,0x49,0x49,0x7F,0x00,0x00,0x04,0x03,0x00,0x07,
0x08,0x08,0x0B,0x08,0x0C,0x01,0x06,0x00,

0x10,0x10,0x28,0x24,0x2A,0x31,0xA2,0x64,0x08,0x10,0x10,0x00,0x08,0x06,0x00,0x06,
...
0x11,0xF2,0x00,0x44,0x28,0xFF,0x00,0xFF,0x28,0x44,0x00,0x00,0x08,0x07,0x08,0x0A,
0x09,0x08,0x08,0x09,0x0A,0x0A,0x0B,0x00,

0x82,0xBA,0xA2,0xB6,0xAA,0xEB,0xAA,0xB6,0xA2,0xBA,0x82,0x00,0x0F,0x00,0x04,0x06,
0x05,0x04,0x06,0x0C,0x00,0x08,0x0F,0x00,
	
0x10,0x1A,0x9E,0xFE,0xFE,0xFF,0xBD,0xFF,0x7F,0x1B,0x08,0x02,0x03,0x03,0x03,0x02,
0x03,0x01,0x03,0x02,0x02,0x02,
...
/*********************整数部分*********************/
		...
		d=(int)num/10%10;
		i=(int)num%10;
		LCD_WriteNumber(X,Y,a);
		LCD_WriteNumber(X+6,Y,b);
		LCD_WriteNumber(X+12,Y,c);
		LCD_WriteNumber(X+18,Y,d);
		LCD_WriteNumber(X+24,Y,i);
		LCD_WriteChar(X+30,Y,'.');
		//LCD_write_number(X+30,Y,10);
/**********************小数部分*********************/
		e=(int)(num*10)%10;
		f=(int)(num*100)%10;
		g=(int)(num*1000)%10;
		h=(int)(num*10000)%10;
		LCD_WriteNumber(X+36,Y,e);
		LCD_WriteNumber(X+42,Y,f);
		LCD_WriteNumber(X+48,Y,g);
		LCD_WriteNumber(X+54,Y,h);
