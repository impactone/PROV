...
const unsigned char number[][6]=/*【数字LCD_write_Number(X,Y,c)】使用，勿动！！！*/
{
...
//6X8字库(字符串【 LCD_write_String(X,Y,*s)】使用，勿动！！！)
...
const unsigned char shuzi[]={/*函数【LCD_write_shu(row, page,c)】使用，勿动！！！*/
/*--  文字:  0  --*/
