...
#define IIC_SDA_Read GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_5)
...
u8  OLED_WriteCommand(uint8_t iic_command);
        ...
        int16_t x,int16_t y,uint16_t showW,uint16_t showH)
{
	...
	OLED_Print6x8Str(x,y,showW,showH,(uint8_t *)Buff,INV_OFF,IS);
}
